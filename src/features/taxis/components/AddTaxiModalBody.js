...
import { addNewTaxi } from '../taxiSlice'
import { post } from '../../../api/api'

const INITIAL_TAXI_OBJ = {
    passengerName: '',
    seatNumber: 1,
    ticketClass: '',
    ticketPrice: '',
...
function AddTaxiModalBody({ closeModal }) {
    const dispatch = useDispatch()
    const [loading, setLoading] = useState(false)
    const [errorMessage, setErrorMessage] = useState('')
    const [taxiObj, setTaxiObj] = useState(INITIAL_TAXI_OBJ)
...
export default AddTaxiModalBody
